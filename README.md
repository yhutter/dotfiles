...
## Color Scheme
I use the `FarOut` color scheme:
- [Neovim](https://github.com/thallada/farout.nvim)
...
## Wallpaper
Wallpaper was made by `jmw327` and can be bought via his Ko-Fi Shop [here](https://ko-fi.com/s/6664076e03).
