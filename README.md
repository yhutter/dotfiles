...
## Colorscheme
I am a huge fan of the `Gruber Darker Theme`:

- [Alacritty](https://github.com/cdunku/dotfiles/blob/main/alacritty/gruber_darker.yml)
- [Neovim](https://github.com/blazkowolf/gruber-darker.nvim)
- [Rider UI Theme](https://plugins.jetbrains.com/plugin/22521-kraggi-theme)
- [Rider Color Theme](https://plugins.jetbrains.com/plugin/23276-gruber-darker)
