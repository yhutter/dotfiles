...
## Color Scheme
I mostly use the `Farout` Color Scheme:
- [Neovim](https://github.com/thallada/farout.nvim/tree/main)

## Wallpaper
Wallpaper can be found [here](https://gruvbox-wallpapers.pages.dev/wallpapers/photography/ameenfahmy-mXpTl4jNKiA.jpg).
