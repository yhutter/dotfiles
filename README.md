...
## Color Scheme
I use the `Scholar` color scheme:
- [Neovim](https://github.com/abreujp/scholar.nvim)
...
## Wallpaper
The Wallpaper can be bought on Ko-Fi [here](https://ko-fi.com/s/6664076e03). I highly recommend supporting the artist!
