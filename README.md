...
## Color Scheme
I use the `Monokai Classic` color theme:
...
## Wallpaper
The wallpaper can be found [here](https://www.reddit.com/r/wallpaper/comments/vwuvp6/5120x2880_triangle_with_a_gradient_based_on_the/#lightbox).
