...
## Color Scheme
I use a modified version of the `Catppuccin Mocha` color scheme. The colors were taken from the `Catppuccin Night` Theme of `ImageGoNord` which can be found [here](https://github.com/Schroedinger-Hat/ImageGoNord-Web/blob/main/src/palettes/Catppuccin/Night.txt).

## Tools
- [Neovim](https://neovim.io/) for text editing
- [Ghostty](https://ghostty.org/) as my main terminal

## Wallpaper
Wallpaper was made by `jmw327` and can be bought on Ko-Fi [here](https://ko-fi.com/s/6664076e03). I used [ImageGoNord](https://ign.schrodinger-hat.it/) to recolor it.

## Setup
Copy the folders into `$HOME/.config`. 

## Acknowledgments
- [0 to LSP by ThePrimeagen](https://www.youtube.com/watch?v=w7i4amO_zaE&ab_channel=ThePrimeagen)
