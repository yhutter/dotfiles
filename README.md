...
## Color Scheme
I use the `Cyberdream Light` color scheme, which can be found [here](https://github.com/scottmckendry/cyberdream.nvim)
...
## Wallpaper
Wallpaper was made by `pixelated_robin` can be found [here](https://pbs.twimg.com/media/GjIGVuJWMAAX6FD?format=jpg&name=large).
...
- [Art made by pixelated_robin](https://pbs.twimg.com/media/GjIGVuJWMAAX6FD?format=jpg&name=large)
