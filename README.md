...
## Color Scheme
I use the `Noirbuddy` color theme:
- [Neovim](https://github.com/jesseleite/nvim-noirbuddy)
...
## Wallpaper
The wallpaper can be found [here](https://www.pexels.com/photo/school-of-koi-fish-2131828/)
