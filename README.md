...
## Color Scheme
I use the `Scholar` color theme:
- [Neovim](https://github.com/abreujp/scholar.nvim/tree/main)
...
## Wallpaper
The Art was made by `Sako` and can be found [here](https://bsky.app/profile/sako.works/post/3ktqdflzkig2d). I merely tweaked the colors a bit to match the `Scholar` Theme. 
...
- [Art made by Sako](https://bsky.app/profile/sako.works/post/3ktqdflzkig2d)
