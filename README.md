...
## Color Scheme
I use the `Monokai Classic` color scheme:
- [Neovim](https://github.com/loctvl842/monokai-pro.nvim)

## Ghostty
To have `Neovide` like cursor animations I use the `smear cursor`:
- [Ghostty Smear Cursor](https://github.com/KroneCorylus/ghostty-shader-playground/blob/main/public/shaders/cursor_smear.glsl)

## Wallpaper
The Wallpaper can be found [here](https://github.com/JJDizz1L/aetheria/blob/omarchy-aetheria-theme/backgrounds/aetheria-1-4k%40.jpg).
