...
## Colorscheme
I use the `Naysayer` color scheme 
- [Neovim](https://github.com/RostislavArts/naysayer.nvim)
- [Ghostty](https://github.com/RostislavArts/naysayer.nvim/issues/3)

## Wallpaper
The Wallpaper can be found [here](https://github.com/krishna4a6av/Wallpapers/blob/master/Everforest/closeflower.jpg).
